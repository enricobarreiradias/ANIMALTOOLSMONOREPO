    ...
    return {
      data: evaluations.map(ev => {
        ...
        return {
            ...
            chip: ev.animal.chip,
            age: ev.animal.age, 
            sisbov: ev.animal.sisbovNumber,
            currentWeight: ev.animal.currentWeight,
            lot: ev.animal.lot,
            birthDate: ev.animal.birthDate ? new Date(ev.animal.birthDate).toLocaleDateString('pt-BR') : undefined,
